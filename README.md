...
| 3 | [`06_mer_ecommerce.html`](./06_mer_ecommerce.html) | Modelo Físico — MER (abrir no navegador) |
...
### Pré-requisitos
- MySQL 8.x instalado
- MySQL Workbench 8.0.46 (opcional, para visualização)

### Opção 1 — MySQL Workbench
```
1. Abra o MySQL Workbench
2. File → Run SQL Script
3. Selecione o arquivo: 05_ecommerce_script.sql
4. Clique em Run
```
...
O script cria o banco `db_ecommerce`, todas as tabelas e insere os dados de teste automaticamente.

---

## 🗺️ Como visualizar o MER

O diagrama MER está no arquivo `06_mer_ecommerce.html`.

```
1. Baixe o arquivo 06_mer_ecommerce.html
2. Abra com qualquer navegador (Chrome, Firefox, Edge...)
3. O diagrama carrega direto, sem necessidade de instalação
```
